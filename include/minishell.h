...
void		assign_exit_code(t_list	*cmdlist, 
				int exit_status_binar, t_big *big);
...
int			fork_and_exe_binary(t_data *comm_info, 
...
int			is_attempt_to_execute(const char *str, 
				const char *str_cmp, int nmb);
